...
def test_executive_data_generation():
    ...
    required_columns = ['Name', 'Title', 'Company', 'Relationship_Score', 
                       'Last_Meeting', 'Next_Meeting', 'Strategic_Initiatives',
...
def test_account_planning_data_generation():
    ...
    # Check required columns
    required_columns = ['Account', 'Health_Score', 'API_Usage', 'Growth_Rate',
                       'Expansion_Opportunities', 'Risk_Level', 'Next_Quarter_Goal',
                       'Strategic_Initiatives', 'Key_Stakeholders', 'Last_QBR', 'Next_QBR']
